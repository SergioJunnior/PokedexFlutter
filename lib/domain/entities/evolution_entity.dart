...
class EvolutionEntity {
  ...
  factory EvolutionEntity.fromJson(String source) =>
      EvolutionEntity.fromMap(json.decode(source));
}
...
class PrimaryPokemon {
  ...
  Map<String, dynamic> toMap() {
    return {
      'evolves_to':
          secondaryPokemon?.map((x) => x.toMap()).toList() ?? const [],
      'isBaby': isBaby,
  ...
  factory PrimaryPokemon.fromMap(Map<String, dynamic> map) {
    return PrimaryPokemon(
      secondaryPokemon: List<SecondaryPokemon>.from(
          map['evolves_to']?.map((x) => SecondaryPokemon.fromMap(x)) ??
              const []),
  ...
  factory PrimaryPokemon.fromJson(String source) =>
      PrimaryPokemon.fromMap(json.decode(source));
}
...
class SecondaryPokemon {
  ...
  factory SecondaryPokemon.fromMap(Map<String, dynamic> map) {
    return SecondaryPokemon(
      terciaryPokemon: List<TerciaryPokemon>.from(
          map['evolves_to']?.map((x) => TerciaryPokemon.fromMap(x)) ??
              const []),
      isBaby: map['isBaby'] ?? false,
      species: Species.fromMap(map['species']),
    );
  ...
  factory SecondaryPokemon.fromJson(String source) =>
      SecondaryPokemon.fromMap(json.decode(source));
}
...
class TerciaryPokemon {
  ...
  factory TerciaryPokemon.fromJson(String source) =>
      TerciaryPokemon.fromMap(json.decode(source));
}
